...
ActiveRecord::Schema.define(version: 20_180_703_145_210) do
  create_table 'hashtags', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
                           force: :cascade do |t|
    t.bigint 'tweet_id'
    ...
    t.index %w[tweet_id name indices], name: 'index_hashtags_on_tweet_id_and_name_and_indices', unique: true
    t.index ['tweet_id'], name: 'index_hashtags_on_tweet_id'
  end

  create_table 'in_tweet_uris', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
                                force: :cascade do |t|
    t.bigint 'tweet_id'
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[tweet_id uri indices], name: 'index_in_tweet_uris_on_tweet_id_and_uri_and_indices', unique: true
    t.index ['tweet_id'], name: 'index_in_tweet_uris_on_tweet_id'
  end

  create_table 'in_user_uris', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
                               force: :cascade do |t|
    t.bigint 'user_id'
    t.string 'uri', default: 'UNKNOWN', null: false
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_id uri indices], name: 'index_in_user_uris_on_user_id_and_uri_and_indices', unique: true
    t.index ['user_id'], name: 'index_in_user_uris_on_user_id'
  end

  create_table 'media', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
                        force: :cascade do |t|
    t.bigint 'tweet_id'
    ...
    t.index %w[tweet_id medium_own_id], name: 'index_media_on_tweet_id_and_medium_own_id', unique: true
    t.index ['tweet_id'], name: 'index_media_on_tweet_id'
  end

  create_table 'search_words', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
                               force: :cascade do |t|
    t.string 'word'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
  ...
  create_table 'tweets', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
                         force: :cascade do |t|
  ...
  create_table 'user_mentions', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
                                force: :cascade do |t|
    t.bigint 'tweet_id'
    t.bigint 'user_id'
    t.string 'indices', default: 'UNKNOWN', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[tweet_id user_id indices], name: 'index_user_mentions_on_tweet_id_and_user_id_and_indices',
                                          unique: true
